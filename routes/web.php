...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => ['auth']], function(){
        ...
        //!settings page
        Route::get('setting', 'Auth\AdminController@showSettingForm')->name('admin.setting.form');
        Route::post('/update/password', 'Auth\AdminController@updatePassword')->name('admin.update.password');

         //!Profile page
         Route::get('profile', 'Auth\AdminController@showProfileForm')->name('admin.profile.form');
         Route::post('/update/profile', 'Auth\AdminController@updateProfile')->name('admin.update.account');
         Route::post('add/admin', 'Auth\AdminController@addAdmin')->name('add.admin');
         Route::post('admin/delete', 'Auth\AdminController@deleteAdmin')->name('admin.delete');
