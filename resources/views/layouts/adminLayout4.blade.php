...
<html>
  ...
  <body>
          ...
          <div class="side-nav">
              <div class="side-nav-inner">
                  <div class="side-nav-logo">
                      <a href="index.html">
                          <div class="logo logo-dark" style="background-image: url('{{asset('assets/images/techfavicon.jpg')}}')"></div>
                          <div class="logo logo-white" style="background-image: url('{{asset('assets/images/techfavicon.jpg')}}')"></div>
                      </a>
    ...
    <script src="{{asset('admin/assets/js/vendor')}}"></script>

    <!-- page plugins js -->
    <script src="{{asset('admin/assets/vendors/bower-jvectormap/jquery-jvectormap-1.2.2.min.js')}}"></script>
    <script src="{{asset('admin/assets/js/maps/jquery-jvectormap-us-aea')}}"></script>
    ...
    <script src="{{asset('admin/assets/vendors/jquery.sparkline/index')}}"></script>
    <script src="{{asset('admin/assets/vendors/chart')}}/dist/Chart.min.js')}}"></script>

    <script src="{{asset('admin/assets/js/app.min.js')}}"></script>

    <!-- page js -->
    <script src="{{asset('admin/assets/js/dashboard/dashboard')}}"></script>
